...
public class MaioreMenornNumero {
	...
	public static void main(String[] args) {
		...
		if(numeroUm <= numeroDois && numeroUm <= numeroTres) {
			System.out.println("O menor numero eh o " + numeroUm);
		}else if(numeroDois <= numeroUm && numeroDois <= numeroTres){
			System.out.println("O menor numero eh o " + numeroDois);
		} else if(numeroTres <= numeroUm && numeroTres <= numeroDois){
			System.out.println("O menor numero eh o " + numeroTres);
		}
