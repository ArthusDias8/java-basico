...
public class ProjetoXadrez {
	...
	public static void main(String[] args) {
		...
		while (!ganhou) {
			...
			while (!colunaValida){
				System.out.println("Escolha com a coluna (1, 2 ou 3)");
				coluna = scan.nextInt();
			...
			if((jogoVelha[0][0] == 'X' && jogoVelha[0][1] == 'X' && jogoVelha[0][2] == 'X') ||  //linha 1 
			...
			} else if((jogoVelha[0][0] == 'O' && jogoVelha[0][1] == 'O' && jogoVelha[0][2] == '0') ||  //linha 1 
				...
				ganhou = true;
				System.out.println("Velha, ninguem venceu a partida!");
			}
